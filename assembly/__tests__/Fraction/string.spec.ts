...
describe('String operations', () => {
  ...
  describe("toFixed", () => {
    ...
    it("Prints output with fixed precision Rounding.UP", () => {
      ...
      const bn = Fraction.fromString(str);
      ...
      const bnNeg = Fraction.fromString(strNeg);
    ...
    it("Prints output with fixed precision Rounding.HALF_UP", () => {
      ...
      const bnHalf = Fraction.fromString(strHalf);
    ...
    it("Prints output with fixed precision Rounding.HALF_EVEN", () => {
      ...
      const bnHalfOdd = Fraction.fromString(strHalfOdd);
